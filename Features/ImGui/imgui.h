...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginMainChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API void          Spacing(int y);                                                 // add vertical spacing.
    ...
    IMGUI_API bool          cfgtab(const char* label, bool active, ImVec2 size_arg);
    IMGUI_API bool          tabby(const char* icon, const char* label, bool selected, ImFont* icon_font = nullptr);
    ...
    IMGUI_API bool          ColorEdit(const char* label, Color* newcolor, bool keybind = false, ImGuiColorEditFlags flags = 0, bool scripts = false);
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker3(const char* label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
    IMGUI_API bool          ColorButton(const char* desc_id, const ImVec4& col, bool keybind, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0, 0));  // display a colored square/button, hover for details, return true when pressed.
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_SkinList = 1 << 29,   // Don't use! For internal use by BeginMenu()
    ImGuiWindowFlags_KeybindWindow = 1 << 30,   // Don't use! For internal use by BeginMenu()
    ImGuiWindowFlags_Watermark = 1 << 31,   // Don't use! For internal use by BeginMenu()
    ImGuiWindowFlags_ColorPicker = 1 << 32   // Don't use! For internal use by BeginMenu()
